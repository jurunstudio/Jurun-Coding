# 저런코딩
저런코딩은 엔트리 오픈소스 라이브러리 ( https://github.com/entrylabs/entryjs )에 기반을 둔 저런스튜디오에서 개발중인 웹 블록 코딩 툴 입니다.

## 시작하기
저런코딩 HTML Canvas와 오디오, 벡터 이미지등을 다루기 위해 몇가지 오픈소스 라이브러리들을 사용합니다.
